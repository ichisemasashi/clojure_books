...
image::images/dynamic_font_lock_off.png[Dynamic Font-lock Off]

And here's how the code looks when it's turned on.

image::images/dynamic_font_lock_on.png[Dynamic Font-lock On]
...
image::images/reader_conditionals.png[Reader Conditionals]
