...
to apply a function over a collection.)
...
what the next section is all about! How about that segue,
eh? Eh?
...
mutable variables. It'll be great!
...
referential transparency, immutability, or both.
...
intensive or that make network requests.
...
some complicated hidden state object.
